...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Frutty Looks Booking Info</title>
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td class="td-padding" align="left" style=" color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                   <h5>Dear {{ $verification->user->fname }} {{ $verification->user->lname }}</h5>
                                   <p> These are the informations regarding your Booking Details made {{ date('F j, Y g:i a',strtotime($verification->created_at)) }}
                                   </p>
                                   <p>
                                       <b>Make-Up Artist Name:- {{ $verification->admin->fname }} {{ $verification->admin->lname }}</b><br>
                                       <b>Date of Appointment:- {{ date('F j, Y', strtotime($verification->date)) }} </b><br>
                                       <b>Time of Appointment:- {{ date('g:i a', strtotime($verification->time)) }}</b><br>
                                       <b>Description of Appointment:- {{ $verification->description }}</b><br>
                                       <b>Appointment Status:- {{ $verification->status }}</b><br>
                                       <b>Reasons why:- {{ $verification->comment }}</b>
                                   </p>
                                   <p>
