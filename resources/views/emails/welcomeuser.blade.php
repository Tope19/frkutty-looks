                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td align="center" class="hund ripplelink" width="600">
                                  <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund" src="{{asset('public') }}/{{ $letter['image'] }}">
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                              <!-- START BODY COPY -->
                              ...
                              <tr>
                                <td class="td-padding" align="left" style=" color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                   <h5>Dear {{ $letter['name'] }}</h5>
                                   <p> Welcome to Africa United Forum! I am so glad to hear from you`ve taken action to join AUF email list and membership to get involved
                                       and stay informed about our work for justice. We seek for our youth and young adults to ensure the African Youth voice is heard and also
                                       to ensure we are an organization meet all mandates given upon ourselves and the community collectively.
                                   </p>
                                   <p>
                                       You can expect to receive emails from me and other AUF staff and board about:
                                       <ul>
                                           <ol> AUF current work , including all projects we have representative located in Africa. </ol>
                                           <ol> Breaking News in Legislation and current affairs. </ol>
                                           <ol> Action alerts when you make a difference from Donations and where these funds are allocated. </ol>
                                           <ol> Invitation to events in your area and across Africa where we have chapters. </ol>
                                           <ol> Opinion pieces from me and other AUF staff on timely issues affecting the everyday Youth.</ol>
                                           <ol> Empowerment Programs. </ol>
                                           <ol> Prison reforms and sponsorships. </ol>
                                           <ol> Business Hub Creations in your community sponsored by AUF. </ol>
                                       </ul>
                                   </p>
                                   
                                   <p>
                                       I hope you won`t need to, but if you feel to opt out of one of these emails or unsubscribe completely, you can easily update your
                                       presence or <b>unsubscribe</b> , located below the join us page on our website.
                                   </p>
                                   <p>
                                       I hope you will take a moment to get familiar with AUF website and learn more about us and the depth and breath of the work we do.
                                       Also check out our online Video`s and Let`s talk pages that promote correspondence between subscribed members, this will give you a little snap
                                       shot of what we do and you can share your friends on social media, AUF promotes unity amongst Africans and those in the diaspora.
                                   </p>
                                   <p>
                                       I will send you from time to time all the ways your impact can be noted and how you can get involved in tthe fight for a stronger Youth and Young Adults.
                                       I`m so glad you joined us.We cannot do this without You.
                                   </p>
                                   <p>
                                       Together we grow
                                   </p>
                                    <img align="center" width="200" style="" src="{{asset('public') }}/{{ $letter['signature'] }}">
                                   <p>
                                       Emmanuel Akeh II
                                   </p>
                                   <p>
                      ...
                      <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                        ...
                        <tr>
                          <td class="td-padding" align="center" style=" color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 0px; padding-left: 0px!important; padding-right: 0px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 0px 0px 0px 0px;">
                            &copy; {{ now()->year }}  Africa United Forum.
                          </td>
                        </tr>
                        <tr>
                          <td align="center" bgcolor="#eeeeee">
                           This is an automated e-mail. Please do not reply to it.Click here to <a href="{{ url('/') }}" target="_blank" style="font-size: 12px; line-height: 14px; font-weight: 500;  color: #212121; text-decoration: underline;padding: 0px; border: 1px solid #eeeeee; display: inline-block;">visit our site.</a>
                          </td>
                        </tr>
                      </table>
                    </td>
